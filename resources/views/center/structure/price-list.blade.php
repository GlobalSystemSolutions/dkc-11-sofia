                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped price-table laboratory">
                                        ...
                                        <tbody>
                                            ...
                                            <tr><td>Диференциално броене на левкоцити и морфология на еритроцитите, ретикулоцити</td><td>5.00 лв.</td></tr>
                                            <tr><td>Скорост на утаяване на еритроцитите (РУЕ)</td><td>2.00 лв.</td></tr>
                                            <tr><td>Време на кървене</td><td>2.00 лв.</td></tr>
                                            <tr><td>Време на съсирване</td><td>2.00 лв.</td></tr>
                                            <tr><td>Протромбиново време</td><td>3.00 лв.</td></tr>
                                            <tr><td>Фибриноген</td><td>3.00 лв.</td></tr>
                                            <tr><td>Химическо изследване на урина със сухи тестове - рН, специфично тегло, белтък, глюкоза, кетони, билирубин, уробилиноген, кръв, левкоцити, нитрити (комплексно); за всеки по:</td><td>6.00 лв.</td></tr>
                                            <tr><td>Седимент</td><td>2.00 лв.</td></tr>
                                            <tr><td>Субстрати: глюкоза, креатинин, урея, билирубин - общ и директен, пикочна к-на, холестерол, триглицериди, HDL - хол., LDL, общ белтък, албумин; за всеки по:</td><td>3.00 лв.</td></tr>
                                            <tr><td>Ензими: АСАТ, АЛАТ, алкална фосфатаза, ГГТ: за всеки по:</td><td>3.00 лв.</td></tr>
                                            <tr><td>Ензими: LDH, алфа НВДН, СРК, алфа-амилаза: за всеки по:</td><td>4.00 лв.</td></tr>
                                            <tr><td>Калций, фосфор, желязо, ЖСК: за всеки по:</td><td>7.00 лв.</td></tr>
                                            <tr><td>Йонизиран калций</td><td>11.00 лв.</td></tr>
                                            <tr><td>Натрий, калий, хлор: за всеки по</td><td>4.00 лв.</td></tr>
                                            <tr><td>Хеликобактер пилори (количествен тест във фецес)</td><td>35.00 лв.</td></tr>
                                            <tr><td>Хеликобактер пилори (качествен тест във фецес)</td><td>15.00 лв.</td></tr>
                                            <tr><td>Кръвнозахарен профил (трикратен)</td><td>7.00 лв.</td></tr>
                                            <tr><td>С-реактивен протеин</td><td>9.00 лв.</td></tr>
                                            <tr><td>Липиден профил (холестерол, HDL, LDL, триглицериди)</td><td>10.00 лв.</td></tr>
                                            <tr><td>ОГГТ (Орален глюкозо толерантен тест)</td><td>7.00 лв.</td></tr>
                                            <tr><td>Васерман</td><td>11.00 лв.</td></tr>
                                            <tr><td>Кръвни групи</td><td>16.00 лв.</td></tr>
                                            <tr><td>Гликиран Hb (HbA1C)</td><td>15.00 лв.</td></tr>
                                            <tr><td>Микроалбуминурия</td><td>15.00 лв.</td></tr>
                                            <tr><td>AST, RF: за всеки по:</td><td>7.00 лв.</td></tr>
                                            ...
                                            <tr><td>Цитонамазка</td><td>15.00 лв.</td></tr>
                                    ...
                                    <table class="table table-striped price-table laboratory">
                                        ...
                                        <tbody>
                                            ...
                                            <tr><td>TgAb + TPOAb</td><td>25.90 лв.</td></tr>
                                            <tr><td>FT3 + FT4 + TSH - (малък пакет)</td><td>34.00 лв.</td></tr>
                                            <tr><td>FT3 + FT4F + TSH + TPOAb + Tg-Ab - (разширен пакет)</td><td>48.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-striped price-table laboratory">
                                        ...
                                        <tbody>
                                            <tr><td>tPSA</td><td>15.00 лв.</td></tr>
                                            <tr><td>CA 19-9</td><td>17.00 лв.</td></tr>
                                            <tr><td>CA 15-3</td><td>17.00 лв.</td></tr>
                                            <tr><td>CA 125</td><td>17.00 лв.</td></tr>
                                    ...
                                    <table class="table table-striped price-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr><td>НОМА (индекс инсулинова резистентност)</td><td>16.00 лв.</td></tr>
                                            <tr><td>25-OH Vitamin D</td><td>20.00 лв.</td></tr>
                                            <tr><td>Osteocalcin (BGP)</td><td>22.00 лв.</td></tr>
                                            <tr><td>Procalcitonin (PCT)</td><td>18.00 лв.</td></tr>
                                            <tr><td>Инсулинов растежен фактор</td><td>45.00 лв.</td></tr>
                                            <tr><td>Vitamin B12</td><td>22.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Консултация по документи</td><td>25.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div id="collapse04" role="tabpanel" aria-labelledby="headingCollapse04" class="collapse" aria-expanded="false" style="">
                            <div class="card-content">
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            <tr><td>Първичен преглед</td><td>40.00 лв.</td></tr>
                                            <tr><td>Вторичен преглед</td><td>32.00 лв.</td></tr>
                                            <tr><td>Консултация по документи</td><td>25.00 лв.</td></tr>
                                            <tr><td>Първична обработка на рана</td><td>25.00 лв.</td></tr>
                                            <tr><td>Вторична обработка на рана</td><td>20.00 лв.</td></tr>
                                            <tr><td>Отстраняване на чужди тела</td><td>30.00 лв.</td></tr>
                                            <tr><td>Имобилизация</td><td>20.00 лв.</td></tr>
                                            <tr><td>Сутура на рана</td><td>25.00 лв.</td></tr>
                                            <tr><td>Инцезия на абсцес</td><td>25.00 лв.</td></tr>
                                            <tr><td>Противотетаничен анатоксин</td><td>7.00 лв.</td></tr>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Домашен медицински преглед</td><td>60.00 лв.</td></tr>
                                            <tr><td>Консултация по документи</td><td>25.00 лв.</td></tr>
                                            <tr><td>Ехокардиография</td><td>40.00 лв.</td></tr>
                                            ...
                                            <tr><td>Холтер ЕКГ- 24 часа</td><td>30.00 лв.</td></tr>
                                            <tr><td>Холтер ЕКГ- 48 часа</td><td>50.00 лв.</td></tr>
                                            <tr><td>Холтер ЕКГ- 72 часа</td><td>65.00 лв.</td></tr>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            <tr><td>Амбулаторен първичен преглед</td><td>40.00 лв.</td></tr>
                                            <tr><td>Амбулаторен вторичен преглед</td><td>32.00 лв.</td></tr>
                                            <tr><td>Ултразвуков преглед</td><td>45.00 лв.</td></tr>
                                            ...
                                            <tr><td>Вземане на биологичен материал – влагалищен секрет, цитонамазка, тест за хламидии – за всяко по отделно единична цена</td><td>10.00 лв.</td></tr>
                                            <tr><td>Преглед и поставяне на влагалищен песар</td><td>45.00 лв.</td></tr>
                                            <tr><td>Преглед с поставяне на вътрематочна спирала</td><td>50.00 лв.</td></tr>
                                            <tr><td>Преглед и екстракция на вътрематочна спирала</td><td>50.00 лв.</td></tr>
                                            <tr><td>Инцизия на фурункул (с лидокаин + 10.00 лв.)</td><td>40.00 лв.</td></tr>

                                            <tr><td>Отстраняване на хирургически шевове</td><td>15.00 лв.</td></tr>
                                            <tr><td>Преглед и колпоскопия</td><td>55.00 лв.</td></tr>

                                            <tr><td>Електрокоагулация</td><td>40.00 лв.</td></tr>
                                            <tr><td>Превръзка суха</td><td>15.00 лв.</td></tr>
                                            <tr><td>Преглед с вземане на цитонамазка</td><td>45.00 лв.</td></tr>
                                            <tr><td>Женска консултация – първичен преглед ехограф</td><td>40.00 лв.</td></tr>
                                            <tr><td>Женска консултация – вторичен преглед</td><td>32.00 лв.</td></tr>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            <tr><td>Амбулаторен първичен преглед</td><td>40.00 лв.</td></tr>
                                            <tr><td>Амбулаторен вторичен преглед</td><td>32.00 лв.</td></tr>
                                            <tr><td>Домашни  прегледи</td><td>60.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Клинико – инструментални изследвания на болни с диабетна невропатия</td><td>15.00 лв.</td></tr>
                                            <tr><td>Интерпретация на остеодензитометрия</td><td>15.00 лв.</td></tr>
                                            <tr><td>Ултразвук на щитовидна жлеза</td><td>40.00 лв.</td></tr>

                                            <tr><td>Обучение на диабетно болни</td><td>25.00 лв.</td></tr>
                                            <tr><td>Амбулаторен преглед с ехограф</td><td>70.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Платен преглед с УЗД</td><td>40.00 лв.</td></tr>
                                            <tr><td>Поставяне (подмяна) на катетър</td><td>25.00 лв.</td></tr>
                                            <tr><td>Амбулаторен преглед с ехограф</td><td>70.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Тест за стрептококи</td><td>10.00 лв.</td></tr>
                                            <tr><td>Амбулаторен преглед с ехограф</td><td>70.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Консултация без преглед (по документи)</td><td>25.00 лв.</td></tr>
                                            <tr><td>Дерматоскопии</td><td>40.00 лв.</td></tr>
                                            <tr><td>Вземане на биологичен материал за изследване</td><td>10.00 лв.</td></tr>

                                            <tr><td>Премахване на молуски (кюретиране) 1бр.</td><td>10.00 лв.</td></tr>
                                            <tr><td>Криотерапия на доброкачествени кожни тумори – до 5  бр., лезии</td><td>30.00 лв.</td></tr>
                                            <tr><td>Криотерапия на доброкачествени кожни тумори – до 10 бр., лезии</td><td>40.00 лв.</td></tr>
                                            ...
                                            <tr><td>Премахване на доброкачествени образувания - среден размер</td><td>50.00 лв.</td></tr>
                                            <tr><td>Премахване на доброкачествени образувания - голям размер</td><td>80.00 лв.</td></tr>

                                            <tr><td>Интердермално тестване или скарификация с един  медикамент</td><td>10.00 лв.</td></tr>
                                            <tr><td>Локална анестезия</td><td>10.00 лв.</td></tr>
                                            <tr><td>Електрокоагулация на фиброми до 5 бр.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Електрокоагулация на фиброми до 10 бр.</td><td>40.00 лв.</td></tr>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Eкстракция на чуждо тяло</td><td>40.00 лв.</td></tr>
                                            <tr><td>Авторефрактометрия с предписание на очила</td><td>45.00 лв.</td></tr>
                                            <tr><td>Изследване на заден очен сегмент – офталмоскопия</td><td>15.00 лв.</td></tr>
                                            <tr><td>Тонометрия</td><td>20.00 лв.</td></tr>

                                            <tr><td>Денонощна крива на ВОН (вътреочно налягане)</td><td>20.00 лв.</td></tr>
                                            <tr><td>Екзофталмометрия</td><td>15.00 лв.</td></tr>
                                            <tr><td>Изследване на цветното зрение</td><td>15.00 лв.</td></tr>
                                            <tr><td>Изследване с триогледално стъкло на Голдман</td><td>45.00 лв.</td></tr>
                                            <tr><td>Гониоскопия</td><td>45.00 лв.</td></tr>

                                            <tr><td>Изследване на зрителна острота без изписване на очила</td><td>15.00 лв.</td></tr>
                                            <tr><td>Изследване на зрителна острота с изписване на очила</td><td>25.00 лв.</td></tr>

                                            <tr><td>Рефрактометрия</td><td>20.00 лв.</td></tr>
                                            <tr><td>Директна офталмоскопия</td><td>20.00 лв.</td></tr>

                                            <tr><td>Индиректна офталмоскопия с 90 диоптр. леща</td><td>25.00 лв.</td></tr>
                                            <tr><td>Биомикроскопия</td><td>20.00 лв.</td></tr>
                                            ...
                                            <tr><td>Отстраняване на шевове</td><td>30.00 лв.</td></tr>
                                            <tr><td>Отстраняване на чуждо тяло</td><td>35.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Амбулаторен вторичен преглед</td><td>32.00 лв.</td></tr>
                                            <tr><td>Домашен медицински преглед</td><td>60.00 лв.</td></tr>
                                            <tr><td>Ехографски преглед</td><td>60.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            ...
                                            <tr><td>Продухване по Полицер</td><td>10.00 лв.</td></tr>
                                            ...
                                            <tr><td>Микробиологично изследване на фарингиален секрет</td><td>20.00 лв.</td></tr>
                                            <tr><td>Микробиологично изследване на назален  секрет</td><td>20.00 лв.</td></tr>
                                            <tr><td>Микробиологично изследване на  ушен секрет</td><td>20.00 лв.</td></tr>
                                            ...
                                            <tr><td>Поставяна на лекарствени вещества в носа при предна риноскопия</td><td>10.00 лв.</td></tr>
                                            <tr><td>Поставяне на медикаменти във външен слухов проход</td><td>10.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            <tr><td>ЕКГ с разчитане</td><td>10.00 лв.</td></tr>
                                            <tr><td>ЕКГ без разчитане</td><td>5.00 лв.</td></tr>
                                            <tr><td>Мускулна инжекция</td><td>5.00 лв.</td></tr>
                                            <tr><td>Подкожна инжекция</td><td>5.00 лв.</td></tr>
                                            <tr><td>Венозна инжекция</td><td>8.00 лв.</td></tr>
                                            <tr><td>Вземане на венозна кръв</td><td>6.00 лв.</td></tr>
                                            <tr><td>Катетеризация</td><td>25.00 лв.</td></tr>
                                            <tr><td>Венозна инфузия – 30 мин.</td><td>20.00 лв.</td></tr>
                                            <tr><td>Венозна инфузия – 60 мин.</td><td>25.00 лв.</td></tr>
                                            <tr><td>Измерване на кръвно налягане</td><td>5.00 лв.</td></tr>
                                            <tr><td>Превръзка / манипулационна</td><td>15.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div id="collapse18" role="tabpanel" aria-labelledby="headingCollapse18" class="collapse" aria-expanded="false" style="">
                            <div class="card-content">
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            <tr><td>Рентгенография на челюсти в специални проекции</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на лицеви кости</td><td>25.00 лв.</td></tr>
                                            <tr><td>Назални кости</td><td>20.00 лв.</td></tr>
                                            <tr><td>Специални центражи на черепа</td><td>30.00 лв.</td></tr>
                                            <tr><td>Синуси</td><td>25.00 лв.</td></tr>
                                            <tr><td>Епифаринкс нативна</td><td>20.00 лв.</td></tr>
                                            <tr><td>Рентгенография на стернум</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на ребра / лява или дясна</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на горни крайници</td><td>15.00 лв.</td></tr>
                                            <tr><td>Рентгенография на раменна става</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на хумерус</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на лакетна става</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на антебрахиум</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на гривнена става- една проекция</td><td>20.00 лв.</td></tr>
                                            <tr><td>Рентгенография на гривнена става- две  проекц.</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на длан и пръсти- две проекции</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на стерноклавикуларна става-един. пр.</td><td>20.00 лв.</td></tr>
                                            <tr><td>Рентгенография на стерноклавикуларна става-две пр.</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на сакроилиачна става</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на тазобедрена става-ед.проек.</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на тазобедрена става-две  проек.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на бедрена кост-един. проекц.</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на бедрена кост- две проекц.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на колянна става-ед. проекц.</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на колянна става-две проекц.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на колянна става с натоварване</td><td>35.00 лв.</td></tr>
                                            <tr><td>Рентгенография на подбедрица ед. проекц.</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на подбедрица две проекц.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на глезенна става- един. проекц</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на глезенна става - две проекц.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на стъпало и пръсти-ед. проекция</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на стъпало и пръсти-две проекц.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на стъпало и пръсти с натоварване</td><td>35.00 лв.</td></tr>
                                            <tr><td>Рентгенография на клавикула</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на акромиоклавикуларна</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на скапула</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на череп - една проекция</td><td>25.00 лв.</td></tr>
                                            <tr><td>Рентгенография на череп- две проекц.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на гръбначни прешлени- една проекц.</td><td>35.00 лв.</td></tr>
                                            <tr><td>Рентгенография на гръбначни прешлени- две проекц.</td><td>30.00 лв.</td></tr>
                                            <tr><td>Рентгенография на гръден кош и бял дроб- една проекц.</td><td>35.00 лв.</td></tr>
                                            <tr><td>Обзорна рентгенография на сърце и медиастинум</td><td>35.00 лв.</td></tr>
                                            <tr><td>Сакрум и опашна кост - ед. проекция</td><td>30.00 лв.</td></tr>
                                            <tr><td>Сакрум и опашна кост - две проекц.</td><td>35.00 лв.</td></tr>
                                            <tr><td>Рентгенография на гръден кош и бял дроб- две проекц.</td><td>40.00 лв.</td></tr>
                                            <tr><td>Обзорна рентгенография на корем за нива</td><td>30.00 лв.</td></tr>
                                            <tr><td>Обзорна рентгенография на корем за БУМ</td><td>35.00 лв.</td></tr>
                                            <tr><td>Рентгенография на таз</td><td>35.00 лв.</td></tr>
                                            <tr><td>Ехографска диагностика на коремни органи</td><td>40.00 лв.</td></tr>
                                            <tr><td>Ехографска диагностика на щитовидна жлеза</td><td>40.00 лв.</td></tr>
                                            <tr><td>Ехографска диагностика на млечна жлеза</td><td>40.00 лв.</td></tr>
                                            <tr><td>Зъбни снимки</td><td>5.00 лв.</td></tr>
                                            <tr><td>Мамография</td><td>40.00 лв.</td></tr>
                        ...
                        <div id="collapse19" role="tabpanel" aria-labelledby="headingCollapse19" class="collapse" aria-expanded="false" style="">
                            <div class="card-content">
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            <tr><td>Амбулаторен първичен преглед</td><td>70.00 лв.</td></tr>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <table class="table table-striped price-table">
                                        <tbody>
                                            <tr><td>Амбулаторен първичен преглед</td><td>40.00 лв.</td></tr>
                                            <tr><td>Амбулаторен вторичен преглед</td><td>60.00 лв.</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
