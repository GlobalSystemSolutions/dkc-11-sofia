...
<div class="specialty-staff-member">
    ...
    <div class="staff-member">
        <div class="staff-member-image">
            <img src="{{ config('app.url') }}/assets/images/profiles/user.svg" title="Д-р Симеон Начев">
        </div>
    ...
    <div class="staff-member-info">
        <div class="staff-member-name">Д-р Симеон Начев</div>
        <div class="staff-member-specialty">Рентгенолог - прави ехография на млечни жлези</div>
