...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ config('app.url') }}/app-assets/css/components.css">
    <!-- END STACK CSS-->
...
<body id="page" data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar">
    ...
    <script src="{{ config('app.url') }}/app-assets/js/scripts/popover/popover.js" type="text/javascript"></script>
