...
@section('title')
    <title>Създаване на обява | ДКЦ XI - София</title>
@endsection
...
<div class="main-content-wrapper contacts">
    <div class="container-fluid">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{ route('admin.career.create') }}">Създаване на обява</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 section-title">Създаване на обява</div>
        </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="POST" action="{{ route('admin.career.create') }}">
                                {{ csrf_field() }}
...
@section('footer-scripts')
    ...
    <script type="text/javascript">
        ...
        $('#position-rating').raty({
            ...
            hints: [ '', '', '', '', '' ],
            score: {{ old('rating') ? (int)old('rating') : 'undefined' }},
            scoreName: "rating"
        });
