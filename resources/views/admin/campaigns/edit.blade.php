...
@section('title')
    <title>Редакция на кампания | ДКЦ XI - София</title>
@endsection
...
<div class="main-content-wrapper contacts">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 section-title">Редакция на кампания</div>
        </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="POST" action="{{ route('admin.campaign.edit') }}">
                                {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-10">
                                                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                                        <label for="title">Име <span class="legend-mark">*</span></label>
                                                        <input type="text" id="title" class="form-control"
                                                            placeholder="Име"
                                                            name="title"
                                                            value="{{ old('title') ? old('title') : $campaign->title }}">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group {{ $errors->has('published_on') ? ' has-error' : '' }}">
                                                        ...
                                                        <input type="text" id="published_on"
                                                            ...
                                                            name="published_on"
                                                            value="{{ old('published_on') ? old('published_on') : $campaign->published_on_string }}"
                                                            required >
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                                        ...
                                                        <input type="text" id="author" class="form-control  "
                                                            placeholder="Автор"
                                                            name="author"
                                                            value="{{ old('author') ? old('author') : $campaign->author }}">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group {{ $errors->has('photographer') ? ' has-error' : '' }}">
                                                        ...
                                                        <input type="text" id="photographer" class="form-control  "
                                                            ...
                                                            name="photographer"
                                                            value="{{ old('photographer') ? old('photographer') : $campaign->photographer }}">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control my-editor" id="body" rows="3" name="body">
                                                            {!! old('body') ? old('body') : $campaign->body !!}
                                                        </textarea>
                                                        @if ($errors->has('body'))
                                                            <span class="help-block">
