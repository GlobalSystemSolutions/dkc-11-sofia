...
@section('title')
    <title>Ново лечебно заведение/база | ДКЦ XI - София</title>
@endsection
...
<div class="main-content-wrapper contacts">
    <div class="container-fluid">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{ route('admin.center.create') }}">Ново лечебно заведение / база</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 section-title">Ново лечебно заведение / база</div>
        </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="POST" action="{{ route('admin.center.new') }}">
                                {{ csrf_field() }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox" class="switch" id="switch" name="active" {{ old('active') ? 'checked' : '' }} >
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="phone_senior_nurse_1" class="form-control  " placeholder="Тел. старша мед. сестра I"
                                                            ...
                                                            value="{{ old('phone_senior_nurse_1') }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="phone_senior_nurse_2" class="form-control  " placeholder="Тел. старша мед. сестра II"
                                                            ...
                                                            value="{{ old('phone_senior_nurse_2') }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="phone_senior_nurse_3" class="form-control  " placeholder="Тел. старша мед. сестра III"
                                                            ...
                                                            value="{{ old('phone_senior_nurse_3') }}" >
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="business_hours_start" class="form-control  " placeholder="00:00"
                                                            ...
                                                            value="{{ old('business_hours_start') }}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="visiting_hours_start" class="form-control  " placeholder="00:00"
                                                            ...
                                                            value="{{ old('visiting_hours_start') }}">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="web_myhealth_address" class="form-control  " placeholder="Линк към Здравен портал"
                                                            ...
                                                            value="{{ old('web_myhealth_address') }}" >
