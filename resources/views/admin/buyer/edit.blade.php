...
@section('title')
    <title>{{ $buyer_type_selected->name }} - Редакция на публикация | ДКЦ XI - София</title>
@endsection
...
<div class="main-content-wrapper contacts">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 section-title">Редакция на публикация</div>
        </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="POST" action="{{ route('admin.buyer.edit') }}">
                                                ...
                                                <div class="col-12 col-md-10">
                                                    <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                                        ...
                                                        <input type="text" id="title" class="form-control"
                                                            ...
                                                            name="title"
                                                            value="{{ old('title') ? old('title') : $buyer->title }}">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group {{ $errors->has('published_on') ? ' has-error' : '' }}">
                                                        ...
                                                        <input type="text" id="published_on"
                                                            ...
                                                            name="published_on"
                                                            value="{{ old('published_on') ? old('published_on') : $buyer->published_on_string }}"
                                                            required >
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="form-group {{ $errors->has('deadline') ? ' has-error' : '' }}">
                                                        ...
                                                        <input type="text" id="deadline"
                                                            class="form-control datepicker"
                                                            name="deadline"
                                                            value="{{ old('deadline') ? old('deadline') : $buyer->deadline_string }}"
                                                            required >
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control my-editor" id="body" rows="3" name="body"  placeholder="Текст на публикацията">
                                                            {!! old('body') ? old('body') : $buyer->body !!}
                                                        </textarea>
                                                        @if ($errors->has('body'))
                                                            <span class="help-block">
