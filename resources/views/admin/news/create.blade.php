...
@section('title')
    <title>Създаване на новина | ДКЦ XI - София</title>
@endsection
...
<div class="main-content-wrapper contacts">
    <div class="container-fluid">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{ route('admin.news.create') }}">Създаване на новина</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 section-title">Създаване на новина</div>
        </div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" method="POST" action="{{ route('admin.news.create') }}">
                                {{ csrf_field() }}
