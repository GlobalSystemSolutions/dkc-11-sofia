            ...
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    <div class="card-title text-center">
                        <div class="resend"><i class="fa fa-envelope"></i></div>
                    </div>
                </div>
                <div class="card-content">
                    ...
                    <div class="card-body pt-0">
                        <form class="form-horizontal" method="POST" action="{{ route('activation.resend.store') }}">
                            ...
                            <button type="submit" class="btn btn-outline-primary btn-block"tabindex="2" ><i class="ft-mail"></i> Изпрати нов имейл за активация</button>
